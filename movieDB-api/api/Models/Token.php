...
class Token extends Model{
    ...
    /*
     * Generate bearer token if it odes not exist for the user and store the token in the database
    ...
    public static function generateBearer($id){
        ...
        //Determine a time in the past: current time minus the lifetime
